...
def get_memory_service():
    """Process-wide Memory Bank service."""
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "4653548824143331328"
    project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-02-7222a271d6bd"
    location = (
